    ...
    <>
      <footer className="footer items-center p-4 pt-12 text-neutral-content bg-white dark:bg-black">
        ...
        <nav className="grid-flow-col mx-auto gap-4 md:place-self-center md:justify-self-end">
          <a href="https://github.com/MalekGhazal" target="_blank">
            <svg
          ...
          <a href="https://www.linkedin.com/in/malekghazal/" target="_blank">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 448 512"
              className="fill-current dark:text-gray-400 dark:hover:text-white text-black hover:text-gray-600"
          ...
          <a href="https://www.instagram.com/malekkazal/" target="_blank">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 448 512"
              className="fill-current dark:text-gray-400 dark:hover:text-white text-black hover:text-gray-600"
