      ...
      <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical px-4 lg:px-0 lg:max-w-screen-xl mx-auto">
        <li>
          ...
          <div className="timeline-start md:text-end mb-10">
            ...
            <br />
            Mastered Adobe Creative Cloud, particularly Photoshop, Illustrator,
        ...
        <li>
          ...
          <div className="timeline-end mb-10">
            ...
            <br />
            Applied strategic approaches to optimize advertising performance and
        ...
        <li>
          ...
          <div className="timeline-start md:text-end mb-10">
            ...
            Studied Software development at Vanier college in Montreal, QC for a
            year and half.
            <br />
        ...
        <li>
          ...
          <div className="timeline-end mb-10">
            ...
            • Utilized the MERN Stack (MongoDB, Express.js, React, and Node.js)
            for development tasks.
            <br />
            • Contributed to the enhancement of user experience and streamlined
            content sharing processes.
            <br />
        ...
        <li>
          ...
          <div className="timeline-start md:text-end mb-10">
            ...
            <br />
            • Demonstrated problem-solving skills by effectively diagnosing and
            resolving backend bugs and issues, improving overall application
