...
const Skills = () => {
  return (
    <>
      <div
        id="skills"
        className="flex items-center bg-white dark:bg-black text-black dark:text-white flex-col h-screen lg:flex-row justify-around gap-10 lg:gap-0 w-full py-32 lg:py-20"
      >
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
